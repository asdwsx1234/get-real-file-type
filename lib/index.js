...
try {
  for (var _iterator = mimeTypes[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    var _mime = _step.value;
    realMimeMapping[_mime] = _mime;
  }
} catch (err) {
...
var TypeFile = function () {
  ...
  function TypeFile(input) {
    ...
    (0, _defineProperty2["default"])(this, "ext", void 0);
    (0, _defineProperty2["default"])(this, "mime", void 0);
    (0, _defineProperty2["default"])(this, "realExt", void 0);
    (0, _defineProperty2["default"])(this, "realMime", void 0);
    this.input = input;
    this.ext = null;
    this.mime = null;
    this.realExt = null;
...
function getType(input) {
  return new Promise(function (resolve, reject) {
    if (!(0, _util.isUint8Array)(input)) {
      ...
      if ((0, _util.isObjectObject)(file) && !(0, _util.isFileInstance)(file)) {
        for (var _key in file) {
          if ((0, _util.isFileInstance)(file[_key])) {
            file = file[_key];
            break;
          }
        }
