...
var getType = function getType(input) {
  return new Promise(function (resolve, reject) {
    if (!(0, _util.isUint8Array)(input)) {
      return fileToUint8Array(input).then(function (u8) {
        return resolve(_objectSpread({
          ext: (0, _util.getFileExt)(input),
...
var fileToUint8Array = function fileToUint8Array(f) {
  var file = f;
  return new Promise(function (resolve, reject) {
...
var exportObj = {
  TypeFile: TypeFile,
  browserMimeMapping: _browserMimeMapping["default"],
  realExtMapping: realExtMapping,
  realMimeMapping: realMimeMapping
};
